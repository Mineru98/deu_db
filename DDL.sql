...
ALTER TABLE "Fan" ADD CONSTRAINT "PK_FAN" PRIMARY KEY (
	"fan_id"
);

ALTER TABLE "Concert" ADD CONSTRAINT "PK_CONCERT" PRIMARY KEY (
	"concert_id"
);
...
ALTER TABLE "AlbumSales" ADD CONSTRAINT "PK_ALBUMSALES" PRIMARY KEY (
	"album_id",
	"fan_id"
);

ALTER TABLE "ConcertTicket" ADD CONSTRAINT "PK_CONCERTTICKET" PRIMARY KEY (
	"fan_id",
	"concert_id"
);
...
ALTER TABLE "AlbumTract" ADD CONSTRAINT "PK_ALBUMTRACT" PRIMARY KEY (
	"album_id",
	"song_id"
);

ALTER TABLE "ConcertTract" ADD CONSTRAINT "PK_CONCERTTRACT" PRIMARY KEY (
	"song_id",
	"concert_id"
);

ALTER TABLE "Artist" ADD CONSTRAINT "FK_Company_TO_Artist_1" FOREIGN KEY (
	"company_id"
)
REFERENCES "Company" (
	"company_id"
...
ALTER TABLE "Concert" ADD CONSTRAINT "FK_Artist_TO_Concert_1" FOREIGN KEY (
	"artist_id"
)
REFERENCES "Artist" (
	"artist_id"
...
ALTER TABLE "Concert" ADD CONSTRAINT "FK_Company_TO_Concert_1" FOREIGN KEY (
	"company_id"
)
REFERENCES "Company" (
	"company_id"
...
ALTER TABLE "Album" ADD CONSTRAINT "FK_Company_TO_Album_1" FOREIGN KEY (
	"company_id"
)
REFERENCES "Company" (
	"company_id"
...
ALTER TABLE "AlbumSales" ADD CONSTRAINT "FK_Album_TO_AlbumSales_1" FOREIGN KEY (
	"album_id"
)
REFERENCES "Album" (
	"album_id"
...
ALTER TABLE "AlbumSales" ADD CONSTRAINT "FK_Fan_TO_AlbumSales_1" FOREIGN KEY (
	"fan_id"
)
REFERENCES "Fan" (
	"fan_id"
...
ALTER TABLE "ConcertTicket" ADD CONSTRAINT "FK_Fan_TO_ConcertTicket_1" FOREIGN KEY (
	"fan_id"
)
REFERENCES "Fan" (
	"fan_id"
...
ALTER TABLE "ConcertTicket" ADD CONSTRAINT "FK_Concert_TO_ConcertTicket_1" FOREIGN KEY (
	"concert_id"
)
REFERENCES "Concert" (
	"concert_id"
...
ALTER TABLE "AlbumTract" ADD CONSTRAINT "FK_Album_TO_AlbumTract_1" FOREIGN KEY (
	"album_id"
)
REFERENCES "Album" (
	"album_id"
...
ALTER TABLE "AlbumTract" ADD CONSTRAINT "FK_Song_TO_AlbumTract_1" FOREIGN KEY (
	"song_id"
)
REFERENCES "Song" (
	"song_id"
...
ALTER TABLE "ConcertTract" ADD CONSTRAINT "FK_Song_TO_ConcertTract_1" FOREIGN KEY (
	"song_id"
)
REFERENCES "Song" (
	"song_id"
...
ALTER TABLE "ConcertTract" ADD CONSTRAINT "FK_Concert_TO_ConcertTract_1" FOREIGN KEY (
	"concert_id"
)
REFERENCES "Concert" (
	"concert_id"
